...
因为当小孩子发育到了七八岁的时候，脑部结果就会逐步趋向成熟。而成熟的标志就是，小孩子不仅仅会开始判断对错，还会开始用抽象的方法来对认识的世界定义化，比如，孝敬父母就是要在喝茶的时候要先给父母奉茶；再比如，小孩子可以用计量单位来概念化地表达他们的需求：250毫升的水是多少这种问题。与此同时，他们的执行功能也会因为脑部发育的健全随之而提升。执行功能如上诉说说，进行一些更加复杂的动作：做饭。
